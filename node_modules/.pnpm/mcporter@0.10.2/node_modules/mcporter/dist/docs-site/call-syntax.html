    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/steipete/mcporter/edit/main/docs/call-syntax.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
...
<li><strong>Optional positional fallback</strong>: omit labels when calling <code>mcporter &#39;context7.resolve-library-id(&quot;react&quot;)&#39;</code>—arguments map to the schema order after any explicitly named parameters.</li>
