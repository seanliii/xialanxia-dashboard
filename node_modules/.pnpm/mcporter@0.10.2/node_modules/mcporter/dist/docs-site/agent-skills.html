    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/steipete/mcporter/edit/main/docs/agent-skills.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
...
<hr>
<p># Docs MCP</p>
<p>Use <code>npx mcporter call docs.resolve-library-id libraryName=&lt;name&gt;</code> to resolve a package, then call <code>npx mcporter call docs.get-library-docs ...</code> with the resolved ID and optional topic. ```</p>
<ol>
