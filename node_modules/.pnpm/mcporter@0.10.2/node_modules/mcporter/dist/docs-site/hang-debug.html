    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/steipete/mcporter/edit/main/docs/hang-debug.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
...
<p>run with <code>--oauth-timeout &lt;ms&gt;</code> (or <code>MCPORTER_OAUTH_TIMEOUT_MS</code>) so the CLI tears down the pending flow instead of waiting the full minute.</p>
</ol>
