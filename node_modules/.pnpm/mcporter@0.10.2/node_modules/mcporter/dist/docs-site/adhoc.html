    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/steipete/mcporter/edit/main/docs/adhoc.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
...
<ol>
<li><strong>Promotes the definition to OAuth</strong> and spins up the default browser flow—no need to edit config or supply <code>auth: &quot;oauth&quot;</code> manually.</li>
