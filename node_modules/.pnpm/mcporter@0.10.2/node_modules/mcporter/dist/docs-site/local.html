    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/steipete/mcporter/edit/main/docs/local.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
...
pnpm mcporter:call context7.get-library-docs topic=hooks</code></pre>
