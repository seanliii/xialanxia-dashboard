    ...
    <main>
      <header class="hero">
        ...
        <div class="hero-meta">
          ...
          <a class="edit" href="https://github.com/steipete/mcporter/edit/main/docs/tool-calling.md" rel="noopener">Edit page</a>
        </div>
      </header>
      <div class="doc-grid">
...
mcporter &#39;context7.resolve-library-id(&quot;react&quot;)&#39;</code></pre>
<ul>
<li>Mirrors the pseudo-TypeScript signature printed by <code>mcporter list</code>.</li>
<li>You may omit labels and rely on the schema order—<code>mcporter &#39;context7.resolve-library-id(&quot;react&quot;)&#39;</code> maps the first argument to <code>libraryName</code> automatically.</li>
