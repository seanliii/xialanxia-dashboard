...
export function renderClientModule(input) {
    ...
    input.docs.forEach((entry, _index) => {
        ...
        lines.push(`      const tool = proxy.${entry.methodName} as (args: Parameters<${input.interfaceName}[${indexKey}]>[0]) => Promise<unknown>;`);
...
function toInterfaceSignature(signature, toolName, options) {
