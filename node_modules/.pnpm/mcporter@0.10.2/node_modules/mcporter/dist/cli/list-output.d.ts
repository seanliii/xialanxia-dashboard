...
export declare function printBriefTool(definition: ReturnType<Awaited<ReturnType<(typeof import('../runtime.js'))['createRuntime']>>['getDefinition']>, metadata: ToolMetadata, requiredOnly: boolean): ToolBriefResult;
