...
export declare function renderTemplate({ runtimeKind, timeoutMs, definition, serverName, tools, generator, metadata, outputPath, runtimeScriptPath }: TemplateInput): string;
...
declare function computeRelativeStdioCwd(definition: ServerDefinition, outputPath?: string): string | null;
export declare const templateTestHelpers: {
    computeRelativeStdioCwd: typeof computeRelativeStdioCwd;
};
export {};
